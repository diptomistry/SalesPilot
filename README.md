...
3. Start MailHog (separate terminal):
...
- ✅ Leads processed end-to-end
- ✅ Emails visible in MailHog
- ✅ CSV updated with AI results
...
**Note**: Make sure to set your `GROQ_API_KEY` in the `.env` file before running `docker compose up`.
